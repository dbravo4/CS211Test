...
//
//  Created by Dale Reed on 11/3/22.
//
/* Sample run:
        compare.c   CS 211 Demo of using elapsed time.
        Which is faster for random adding and deleting elements:
           - an array that keeps getting compacted, or a linked list?
        Author: Dale Reed on an iMac, 3.6 GHz 10 core i9, using Xcode.
        Elapsed seconds for various sizes:
